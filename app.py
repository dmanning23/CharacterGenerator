...
def generate_character(name, gender, age, personality):
...
def main():
    ...
    custom_functions = [
    {
        ...
        'description': 'Generate a random character based on a short description',
        'parameters': {
            'type': 'object',
            'properties': {
                'name': {
                ...
                'age': {
                    'type': 'integer',
                    'description': 'Age of the person between 0 and 101'
                },
                'personality': {
                    'type': 'string',
                    'description': "A short description of the character's personality, with no location or relationship data. Generate this from the user's name, age, and gender."
                }
            },
    ...
    with container:
        with st.form(key="my form", clear_on_submit=True):
            user_input  = st.text_area(label="Enter a short description of the character: ", key="input", height = 100)
